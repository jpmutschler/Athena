...
|   +-- workflows/              # 18 validation recipes + workflow builder + control flow
...
|       |-- ltssm_trace.py
|       |-- performance.py
|       |-- workflow_builder.py # Multi-recipe workflow composer with control flow
|       +-- workflow_builder_helpers.py # Pure conversion helpers for builder state
|
+-- utils/
