...
def _setup_platform_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.switchtec_cmd.argtypes = [c_void_p, c_uint32, c_void_p, c_size_t,
                                   c_void_p, c_size_t]
    ...
    lib.switchtec_pff_to_port.argtypes = [c_void_p, c_int, POINTER(c_int),
                                           POINTER(c_int)]
...
def _setup_status_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.switchtec_get_device_info.argtypes = [c_void_p, POINTER(c_int),
    ...
    lib.switchtec_calc_lane_id.argtypes = [c_void_p, c_int, c_int,
                                            POINTER(SwitchtecStatus)]
...
def _setup_event_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.switchtec_event_ctl.argtypes = [c_void_p, c_int, c_int, c_int,
                                         POINTER(c_uint32)]
...
def _setup_fw_functions(lib: ctypes.CDLL) -> None:
    ...
    # Minimal set for now; extended in Phase 6
    pass
...
def _setup_bw_lat_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.switchtec_bwcntr_many.argtypes = [c_void_p, c_int, POINTER(c_int),
                                           c_int, POINTER(SwitchtecBwCntrRes)]
    ...
    lib.switchtec_bwcntr_all.argtypes = [c_void_p, c_int,
    ...
    lib.switchtec_lat_get.argtypes = [c_void_p, c_int, c_int,
                                       POINTER(c_int), POINTER(c_int)]
...
def _setup_diag_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.switchtec_diag_cross_hair_get.argtypes = [
        c_void_p, c_int, c_int, POINTER(SwitchtecDiagCrossHair)
    ]
    ...
    lib.switchtec_diag_eye_start.argtypes = [
        c_void_p, c_int * 4, POINTER(Range), POINTER(Range),
        c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_uint64, c_int
    ]
    ...
    lib.switchtec_diag_eye_fetch.argtypes = [c_void_p, POINTER(c_double),
                                              c_size_t, POINTER(c_int)]
    ...
    lib.switchtec_diag_eye_read.argtypes = [c_void_p, c_int, c_int,
    ...
    lib.switchtec_diag_loopback_get.argtypes = [
        c_void_p, c_int, POINTER(c_int), POINTER(c_int)
    ]
    ...
    lib.switchtec_diag_pattern_mon_get.argtypes = [
        c_void_p, c_int, c_int, POINTER(c_int), POINTER(c_uint64)
    ]
    ...
    lib.switchtec_diag_ltssm_log.argtypes = [
        c_void_p, c_int, POINTER(c_int), POINTER(SwitchtecDiagLtssmLog)
    ]
...
def _setup_osa_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.switchtec_osa_config_type.argtypes = [
        c_void_p, c_int, c_int, c_int, c_int, c_int
    ]
